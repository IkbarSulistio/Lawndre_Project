  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
          ...
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: _image != null
                  ...
                  : AssetImage('assets/default_avatar.png') as ImageProvider, // Default Avatar jika belum ada gambar yang dipilih
            ),
        ...
        Text('User_1945', style: TextStyle(fontSize: 18)), // Nama pengguna
        Text('User1945@gmail.com', style: TextStyle(fontSize: 14, color: Colors.grey)), // Email pengguna
        Text('+6281234684952', style: TextStyle(fontSize: 14, color: Colors.grey)), // Nomor telepon pengguna
      ],
    );
  }
}